...
function App() {
  return (
    <main className="flex min-h-svh w-full flex-col items-center gap-8 overflow-x-hidden bg-white px-6 py-10 text-slate-900 dark:bg-slate-900 dark:text-slate-100">
